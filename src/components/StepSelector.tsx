function StepSelector() {
  return (
    <div className="flex justify-center overflow-x-auto custom-scrollbar py-4 px-4">
      <div className="flex items-center space-x-4">
        ...
        <div className="w-16 h-px bg-[#2A2A2A]"></div>
        <button disabled className="flex items-center whitespace-nowrap transition-colors text-white/60 cursor-not-allowed opacity-50">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-credit-card w-6 h-6"><rect width="20" height="14" x="2" y="5" rx="2"></rect><line x1="2" x2="22" y1="10" y2="10"></line></svg>
